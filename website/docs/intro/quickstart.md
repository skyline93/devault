...
以下步骤假设你在仓库根目录克隆了 DeVault，并已安装 Docker Compose。
...
| `http://127.0.0.1:8000/ui/jobs` | 简易 Web UI（Basic 密码为 `DEVAULT_API_TOKEN`） |
| `http://127.0.0.1:8000/metrics` | Prometheus 指标 |

更多环境变量与生产拓扑见 [安装与运行](../install/docker-compose.md) 与 [配置参考](../install/configuration.md)。
